...
## Acceptance
- [x] Implemented and owner-verified via deviz subtasks dv-ee06/dv-f0d5/dv-82c8/dv-94bd (see board-ff8aeb03)
...
- 2026-07-19 done
- 2026-07-19 changelog: Agentic AI channel: /ask and voice run a tool-calling session — raw-row transaction queries + recurring add/cancel staged behind confirm buttons
