...
HELP_TEXT = """
О приложении☝🏼 Новая версия 0.0.3 от 14.06.23. 👌🏼 
Добавлены новые функции. 🎉
Возможность установки месячного лимита и отслеживания ежедневных расходов. Пожалуйста, перезапустите /start, чтобы установить лимит.
