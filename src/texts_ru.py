...
HELP_TEXT = """
О боте☝🏼 Новый релиз 0.1.4 от 24.04.24. 👌🏼 
...
SELECT_TRANSACTION_CATEGORY = "Пожалуйста, выберите категорию для вашей транзакции из предыдущих транзакций или отправьте транзакцию в чате в формате: Транзакция сумма"
...
BACK_TO_TASKS_BUTTON = "🔙 Назад к траты"
