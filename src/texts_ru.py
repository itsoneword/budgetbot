...
TRANSACTION_DETAILS_INCOME = "💵 <b>Детали дохода</b>\n\nДата: {timestamp}\nКатегория: {category}\nСумма: {amount} {currency}\n\nВыберите, что вы хотите отредактировать:"
...
ENTER_NEW_INCOME_CATEGORY = "Пожалуйста, введите новую категорию дохода:"
...
CONFIRM_DELETE_INCOME = "Вы уверены, что хотите удалить эту запись о доходе?\n\n💵 Дата: {timestamp}\nКатегория: {category}\nСумма: {amount} {currency}"
EDIT_TYPE_MISMATCH = "⚠️ Эта опция недоступна для данного типа записи — меню редактирования обновлено."
...
REMINDER_STATUS_OFF = (
    ...
    "Если в этот день вы уже что-то записали, напоминать не буду.\n\n"
    "Можно также написать /reminder 17:00 или /reminder off."
)
REMINDER_STATUS_ACTIVE = (
    "⏰ Ежедневное напоминание установлено на {time} (по вашим часам).\n"
    "Выберите новое время или выключите:"
)
REMINDER_SET = (
    "⏰ Готово — буду напоминать каждый день в {time} (по вашим часам) записать траты. "
    "В дни, когда вы уже что-то записали, напоминать не буду.\n"
    "Выключить можно в любой момент: /reminder off."
)
...
REMINDER_USAGE = (
    "/reminder — настройки напоминания\n"
    "/reminder 17:00 — напоминать каждый день в 17:00\n"
    "/reminder off — выключить напоминание"
)
REMINDER_OFF_BTN = "🔕 Выключить"
TZ_PICK_PROMPT = (
